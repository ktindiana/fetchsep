...
Ready to contribute? Here's how to set up `fetchsep` for local development.

1. Fork the `fetchsep` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/fetchsep.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv fetchsep
    $ cd fetchsep/
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_fetchsep
