...
#                    event_ended = True
#                    event_end_time = dates[i-(end_counter-1)] #correct back time steps
...
def run_all(str_startdate, str_enddate, experiment, flux_type, model_name,
    ...
    #COMMENTED OUT MEANS THE CODE HAS BEEN REPLACED ABOVE
    #PROCESS INPUTS
