...
def set_resume_dates(params):
    ...
    df = pd.read_csv(os.path.join(params.idsep_path, params.idsep_fname_background))
...
def back_up_resume_files(params):
    ...
    if params.module_outpath != params.idsep_path:
        return
    ...
    for filenm in [params.idsep_fname_background, params.idsep_fname_sigma,
        ...
        filename = os.path.join(params.idsep_path, filenm)
...
def clean_up_resume_files(params):
    ...
    for filenm in [params.idsep_fname_background, params.idsep_fname_sigma,
        ...
        filename = os.path.join(params.idsep_path, filenm + '.bak')
        os.remove(filename)
