...
#./deploy_CLEAR_Linux.sh ALL
#./deploy_CLEAR_Linux.sh BATCH
#./deploy_CLEAR_Linux.sh COMPILE
...
######################################################################
# If all batch runs of OPSEP are already complete and want to extract to a single list.
